...
**${\color{darkblue}\text{Adaptive sequential surveillance with network and temporal dependence.}}$**<br> 
*I. Malenica*, J. R. Coyle, M. J. van der Laan, and M. L. Petersen. <br>
*Biometrics*, 2023.<br>
[Available here.](https://arxiv.org/abs/2212.02422)


**${\color{darkblue}\text{Anytime-valid inference in n-of-1 trials.}}$**<br> 
...
**${\color{darkblue}\text{Causality in goal conditioned RL: Return to no future?}}$**<br>
...
**${\color{darkblue}\text{Personalized online ensemble machine learning with applications for dynamic data streams.}}$**<br>
...
**${\color{darkblue}\text{Multi-task highly adaptive lasso.}}$**<br>
...
**${\color{darkblue}\text{Kernel debiased plug-in estimation.}}$**<br>
...
**${\color{darkblue}\text{Adaptive sequential design for a single time-series.}}$**<br>
